...
Use this reference for Spanner and AlloyDB integration, database transfers and reverse ETL, migration assessment, SQL translation, and metadata movement.
...
## Migration assessment and workflows

### Hadoop and Cloudera migration assessment

*2025-06*

In Preview, BigQuery migration assessment can assess workflows that use Cloudera and Apache Hadoop.

### Hadoop migration workflows
...
## SQL translation and schema mapping

### Gemini-enhanced SQL translation
...
### Impala and GoogleSQL translation
...
### Snowflake SQL translation mapping
