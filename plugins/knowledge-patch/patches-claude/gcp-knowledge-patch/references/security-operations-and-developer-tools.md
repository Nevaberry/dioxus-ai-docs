...
Use this reference for IAM, organization policy, encryption, governance, billing attribution, audit behavior, quotas, MCP enablement, and API controls.
...
## IAM and resource access

### Agent Engine Access Transparency

*2025-10*

Access Transparency is available for Vertex AI Agent Engine.

### BigQuery data preparation lifecycle and IAM
...
### BigQuery Data Transfer defaults and IAM
...
### Dataset IAM permission enforcement
...
### Automatic MCP enablement and policy migration
...
### BigQuery custom constraints on additional resources
...
### Custom constraints for BigQuery sharing
...
## Encryption, masking, and jurisdiction

### BigQuery CMEK key rotation
...
### Gemini in BigQuery data jurisdiction
...
### Automatic BigQuery ML quota synchronization
...
### BigQuery daily token quotas temporarily unavailable
...
### BigQuery Data Transfer billing label migration
...
### BigQuery Migration Service billing-account requirement
...
### BigQuery regression re-execution audit identity
...
## MCP, APIs, and developer controls
...
### Data policies directly on BigQuery columns
...
### Default Gemini API enablement for BigQuery
