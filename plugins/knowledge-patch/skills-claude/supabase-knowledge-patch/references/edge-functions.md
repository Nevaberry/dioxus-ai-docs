...
Use this reference for dependency manifests, invocation behavior, filesystem access, deployment, quotas, regions, and metrics.

## Supabase JS compatibility (`supabase-js-2.101.0`)

### Canonical Edge Function CORS headers
...
## Packaging and hosted runtime behavior
...
### Per-function Edge Function metrics
