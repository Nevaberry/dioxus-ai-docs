...
Use this reference before selecting GKE versions, release channels, compute, networking, storage, security, or observability features.
...
### Concurrent GKE node-pool upgrades
...
### Expanded GKE maintenance exclusions
...
### GKE 2026-R24 and R25 channel versions
...
### GKE control-plane upgrade controls
...
### GKE surge-upgrade concurrency limit
...
### N4D cluster autoscaling version correction
...
## Networking, Gateway, and load balancing

### GKE 1.36 internal load balancer default
...
### GKE Gateway backend authenticated TLS
...
### GKE Gateway backend mutual TLS
...
### NodeLocal DNSCache becomes a Standard default
...
### Automated GKE disk-type selection
...
### Cloud Storage FUSE mount delays on GKE
...
### Cloud Storage FUSE mount failures during GKE startup
...
### Cloud Storage FUSE on GKE Dedicated
...
### Cloud Storage FUSE reads on 64 KiB ARM64 nodes
...
### Cloud Storage FUSE streaming-write failures
...
## Compute, accelerators, and confidential workloads

### C4A bare-metal nodes on GKE
...
### C4A bare-metal nodes reach GA on GKE

*2026-05*

C4A bare-metal instances are GA with GKE clusters.

### C4A bare-metal support expansion
...
### Distributed inference in GKE Inference Quickstart
...
### Image streaming on Ubuntu GKE nodes
...
## Autopilot, scheduling, and admission

### Autopilot NRI failure fix
...
### Mutating Admission Policies on GKE
...
### Privileged Autopilot workload allowlists
...
### Workload Identity timeouts after GKE node startup
...
### `kubectl` removal from Container-Optimized OS
...
### Multimodal agent telemetry on GKE
...
### Pressure Stall Information metrics on GKE
...
### Stricter GKE `HealthCheckPolicy` validation
