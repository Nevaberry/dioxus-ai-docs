...
Use this reference for BigQuery SQL and administration, data preparation and pipelines, lakehouse and sharing workflows, transfers, Pub/Sub, Connected Sheets, and client behavior.
...
## SQL, functions, and query execution
...
### Additional BigQuery transfer sources
...
### BigQuery client feature rollout
...
**2025-07:** GA data preparation can flatten a JSON column in one operation, and Access Transparency now covers data-preparation activity. In Preview, an undeployed data preparation can be run manually in development using the developer's Google Account credentials.

**2025-09:** Preview data preparations can load files from Cloud Storage, and GA data preparations can unnest an array so each element becomes a separate row.

### BigQuery Data Transfer sources
...
### BigQuery Data Transfer updates
...
### BigQuery data-preparation operations GA

*2025-11*

Gemini-assisted aggregation and deduplication in BigQuery data preparations are GA.

### BigQuery data-preparation source and operations
...
### BigQuery Go disaster-recovery fields
...
### BigQuery Java and Python client additions
...
### BigQuery Java client 2.58 release candidate
...
### BigQuery metastore Iceberg integrations
...
### BigQuery name-based set operations
...
### BigQuery Notebook code generation
...
### BigQuery on-demand query limit
...
### BigQuery performance assistance
...
### BigQuery policy controls reach GA
...
### BigQuery Python client 3.32 and 3.33
...
### BigQuery repositories and pipelines
...
### BigQuery reservation groups reach GA
...
### BigQuery Studio model creation and comments
...
### BigQuery workload-management constraints
...
### Catalog-published data quality results
...
### Custom paths for BigQuery remote functions
...
### External-data null and column matching
...
### Flexible BigQuery reservations
...
### Global BigQuery default location
...
### GoogleSQL chained function calls
...
### GoogleSQL default for CLI and API queries
...
### GoogleSQL multi-level aggregation
...
### Identity-based BigQuery reservation routing
...
### Materialized views over active CDC tables
...
### Multi-region BigQuery sharing listings reach GA

*2026-05*

Configuring one BigQuery sharing listing for multiple regions is GA.

### Natural-language SQL comments
...
### Query location system variable
...
### Strict act-as enforcement for BigQuery workflows
...
## Data preparation, notebooks, repositories, and pipelines

### Code-asset folder operations
...
### Table Explorer moves to the Reference panel

*2026-06*

Table Explorer behavior is scheduled to move into BigQuery's **Reference** panel in July 2026 or later.

## Transfers, connectors, and scheduled movement

### Advertising transfer controls
...
### Advertising-transfer backfill retention
...
### Facebook Ads `AdInsightsMMM` transfers paused
...
### Analytics Hub Marketplace APIs for Go
...
### BigLake Iceberg REST catalog federation
...
### External catalog metadata migration
...
### Iceberg external-table time travel
...
### Iceberg REST catalog credential vending
...
### Pub/Sub external import topics
...
### Pub/Sub Go resource tags and ingestion diagnostics
...
### Pub/Sub Go subscriber shutdown controls

*2025-09*

Pub/Sub Go v2.1.0 adds subscriber shutdown options.

### Pub/Sub Go v2 library
...
### Pub/Sub Java streaming-pull keepalive
...
### Pub/Sub message-transform client migration
...
### Pub/Sub schema violation diagnostics
...
## Reservations, capacity, and workload management

### Connected Sheets pivot-table capacity

*2025-10*

BigQuery-backed pivot tables in Connected Sheets now support 200,000 rows, up from 100,000.

### Per-second reservation telemetry
...
## Administration, monitoring, and interface behavior

### `pyproject.toml` source deployments
...
### Data-service remote MCP servers
...
### Direct VPC egress address consumption
...
### History-based optimization default
...
### Image-generation endpoint migrations
...
### Materialized-view smart-tuning scope
...
### Organization-wide search-index accounting
...
### Private NAT for Direct VPC egress

*2025-05*

In Preview, Cloud Run Direct VPC egress can use Private NAT.

### Project-wide metadata scan administration
...
### Shared and role-authorized stored procedures
...
### TransUnion entity resolution

*2025-10*

BigQuery entity resolution supports TransUnion at GA.

### Vector-index drift and rebuilds
...
### Virtual Try-On endpoint migration
