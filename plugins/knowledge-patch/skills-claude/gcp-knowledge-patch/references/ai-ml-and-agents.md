...
Use this reference when selecting or migrating models, building agents, evaluating or tuning AI systems, generating media, or using BigQuery AI and ML.
...
## Lifecycle, endpoints, and availability
...
### Agent Engine lifecycle and regions
...
### Agent Engine SDK client migration
...
### Gemini 2.5 GA endpoint migration
...
### Gemini 2.5 Preview endpoint remapping
...
### Vertex AI media endpoint migrations
...
## Agents, RAG, and developer tooling
...
### Agent Engine execution and protocols
...
### Agent Engine identity and enterprise controls
...
### Agent Engine management and sessions
...
### Agent Engine management capabilities
...
### Apache Arrow Storage Write API input
...
### BigQuery Data Science Agent reaches GA

*2026-05*

The Data Science Agent for Colab Enterprise and BigQuery is GA.

### BigQuery Storage partition request limit
...
### Conversational Analytics agents in Gemini Enterprise
...
### Data Science Agent prompt inputs
...
### Gemini Cloud Assist for BigQuery operations
...
### Gemini Cloud Assist lineage and scheduling
...
### Saving BigQuery results to Cloud Storage

*2025-08*

At GA, BigQuery can save query results directly to Cloud Storage.

### Vertex AI Agent Builder naming
...
## BigQuery AI, ML, search, and forecasting

### Automatically deployed BigQuery ML open models
...
### Autonomous embedding generation and `AI.SEARCH`
...
### Autonomous embedding generation reaches GA
...
### BigQuery `ObjectRef` functions reach GA
...
### BigQuery conversational analytics additions
...
### BigQuery conversational analytics Preview
...
### BigQuery conversational analytics reaches GA
...
### BigQuery generative AI function surface
...
### BigQuery managed AI function updates
...
### BigQuery ML bucket output formats
...
### BigQuery ML embedding remote models
...
### Claude remote models in BigQuery ML
...
**2025-01:** The Preview `TIME_SERIES_ID_COL` option lets one BigQuery ML `ARIMA_PLUS_XREG` multivariate time-series model forecast multiple series.

```sql
OPTIONS(MODEL_TYPE = 'ARIMA_PLUS_XREG', TIME_SERIES_ID_COL = 'series_id')
```

**2025-06:** The `TIME_SERIES_ID_COL` option for forecasting multiple time series with one `ARIMA_PLUS_XREG` multivariate model is GA.

### Multimodal Gemini embeddings in BigQuery
...
### TimesFM forecasting and anomaly functions
...
### TimesFM functions in Connected Sheets
...
### Gemini image generation and seed support
...
### Veo 3.1 reference-to-video additions
...
### Vertex AI media-generation models
...
## Evaluation, tuning, grounding, and observability
...
### Model Garden fine-tuning and evaluation additions
...
### Model Garden medical models and Gemma fine-tuning
...
### Conversational analytics glossaries
...
### Conversational analytics over lakehouse catalogs
...
### Gemini 2.5 Flash Live API updates
...
**2025-02:** Model Garden adds Phi-4 plus Preview DeepSeek-V3 and DeepSeek-R1 671B models. Managed Llama 3.3 70B and Anthropic Claude Sonnet 3.7 are also available in Preview.

**2025-04:** Model Garden adds HiDream-I1, Llama Guard 4, Llama Prompt Guard 2, and Qwen3.

**2025-08:** Model Garden adds `gpt-oss-120b`, `gpt-oss-20b`, Qwen3 Coder, and Qwen3 235B as Model-as-a-Service models. Gemma 3 270M, Wan 2.1, and Wan 2.2 models are also available through Model Garden.

**2025-09:** Model Garden adds EmbeddingGemma, DeepSeek-V3.1, DeepSeek-V3.1-Terminus, DeepSeek-V3.2-Exp, and the Southeast-Asian-language SEA-LION V4 models.

**2025-11:** Model Garden adds MiniMax M2 and Kimi K2 Thinking as managed APIs and makes Claude Opus 4.5 available.

**2025-12:** Model Garden adds DeepSeek-V3.2, DeepSeek-V3.2-Speciale, Ministral 3, Mistral Large 3, FunctionGemma, and T5Gemma 2. DeepSeek-V3.2 is also available as a managed API.

### Model Garden additions and deployment
...
### Model Garden additions and TPU serving
...
### Model Garden inference optimizations
...
### Stored-column usage for vector search
...
### Vertex AI Studio prompt sharing
