...
## Realtime bindings must precede subscription (supabase-js-2.101.0)
...
## Realtime protocol and heartbeat updates (supabase-js-2.101.0)
...
## The `realtime` schema is protected (1.26.08)
