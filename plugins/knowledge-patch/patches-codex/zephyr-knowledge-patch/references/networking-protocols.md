...
Use these notes for networking core, sockets, HTTP, CoAP, LwM2M, Ethernet L2, MQTT, DNS, DHCP, OpenThread, Wi-Fi, and radio protocols.

## Networking core, sockets, and Ethernet L2
...
## MQTT, modem, LoRa, and other protocols
