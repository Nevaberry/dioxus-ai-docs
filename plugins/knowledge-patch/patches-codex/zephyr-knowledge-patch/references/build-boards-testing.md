# Builds, Boards, Flashing, and Testing

Use these notes for west and CMake builds, sysbuild, board targets, flash runners, native simulation, toolchains, Twister, and ztest.

## Build system, sysbuild, and toolchains
