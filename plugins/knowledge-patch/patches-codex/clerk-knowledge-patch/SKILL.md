...
| [Authentication and sessions](references/authentication-and-sessions.md) | Factors, SSO, OAuth/OIDC, passkeys, trusted devices, pending sessions, reverification, JWT claims, restrictions |
| [Billing](references/billing.md) | Plans, Features, Subscriptions, trials, discounts, checkout, hooks, administration |
...
| [Organizations and enterprise](references/organizations-and-enterprise.md) | Tenant scoping, roles, permissions, role sets, invitations, Verified Domains, enterprise connections and sync |
