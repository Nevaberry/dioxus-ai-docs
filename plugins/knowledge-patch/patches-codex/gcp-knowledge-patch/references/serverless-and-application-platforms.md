...
Use this reference for serverless and application platforms compatibility details and current behavior.

## Deployments, source builds, and runtimes
...
### Compose deployments to Cloud Run (2025-11, 2026-03)
...
### Direct Cloud Run source artifacts (2025-11)
...
### Public GitHub Container Registry images on Cloud Run (2026-07-2)
...
### Cloud Run L4 GPU driver (2026-07-2)
...
## Health, observability, and service topology
...
## Functions, integrations, and platform behavior

### Artifact Registry repositories for Cloud Run functions (2025-02)
...
### Developer Connect continuous deployment (2025-12)
